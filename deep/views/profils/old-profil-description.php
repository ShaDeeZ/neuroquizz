...
<body>
    ...
    */
            ...
            ?>
                <div class="div_card_and_categories">
                    <div class="div_card_categorie">

                        <div class="div_all_card_categories">
                            ...
                            <div class="div_nom  flex-center flex-col relative" style="background-color:<?= $tabColor[$id_profil]['color'];; ?>;">
                                <p id="p_nom_perso">
                                    <?= $personalite['nom']; ?>
                                </p>

                                <p id="p_slogan">
                                    <?= (empty($tabDetailSlogan)) ? 'pas de slogan' : $tabDetailSlogan[0]['detail']; ?>
                                </p>
                            </div>
                        </div>
                    </div>

                    <div class="categories flex-center flex-col">
                        <?php
                        $x = 0;
                ...
                <div class="mots_clefs flex-col flex-center">
                    <h2>Maîtres-mots : </h2>
