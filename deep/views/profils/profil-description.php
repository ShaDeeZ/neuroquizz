...
$id_profil = sanatizeString($_GET['perso']);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    */
            ...
            ?>
                ...
                <div class="div_card_and_categories flex-center spaced-around">

                    <div class="div_card_categorie">

                        <div class="div_all_card_categories_profil relative">

                            <div class="div_img_categories">
                                <img id="img_personalite" src="<?= (empty($tabDetailImg)) ? '../../assets/img/res/btn-add.png' : '../../assets/' . $tabDetailImg[0]['detail']; ?>" />
                            </div>

                            <div class="div_nom relative spaced-around flex-center flex-row" style="background-color:<?= $tabColor[$id_profil]['color'];; ?>;">
                    ...
                    <div class="categories div_text_profil flex-col">
                        <?php
                        $x = 0;
                        ...
                        ?>
                            <div class="div_all_categories">
                                ...
                                <div class="div_more_info_ctagories <?= $isNone; ?>">
                ...
                <div class="all_mots_clefs flex-center">
                    <div class="mots_clefs flex-col">
                        ...
                        <div class="flex-row flex-center div_mots_clefs flex-wrap spaced-around">
                            ...
                            ?>
                                    <div class="motsclefsProfil flex-center" style="background-color:<?= $tabColor[$id_profil]['color']; ?>;">
                                        <p>
