...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=AR+One+Sans:wght@400;500&family=Lato&family=Maitree:wght@700&family=Open+Sans:wght@300&display=swap"
        rel="stylesheet">
...
<body>
    ...
    <div class="div_body">
        <div class="flex-center spaced-around">
            <div class="div_progress">
                <div class="progress" style="width:<?= $progressPixelBar; ?>px !important;"></div>
            </div>
            <div>
                <p class="text-right">Veuillez sélectionner 3 réponses</p>
            </div>
        </div>
        <?php
        if ($question['num_q'] == 1) {
            ?>
        <div class="div_popup flex-center" id="div_popup" onclick="removePopup(event)">
            <div class="div_p_popup">
                <p class="p_popup"> Veuillez sélectionner 3 réponses </p>
            </div>
        </div>
            <?php
        }
        ...
        <div class="div_all_img flex-row flex-wrap">
            ...
            <div class="div_container_rep flex-center">
                <div class="flex-row flex-wrap flex-center div_rep_question">
                    ...
                    foreach ($tabRes as $reponse) { ?>
                        ...
                        <div class="card_rep_other flex-col flex-center" onclick="selectReponse(event)"
                            data-perso="<?= $reponse['id_perso']; ?>">
                            ...
                            <div class="flex-center">
                                <p class="p_title_reponse text-center">
            ...
            <div class="div_fleche flex-center flex-row fixed">
                ...
                <form id="monFormulaire" method="post" action="../../model/survey/next-question.php">
                    <input id="input_reponse" class="none" type="text" value="0" name="reponses">
                    <p id="p_warning_test" class="none red"> Veuillez sélectionner 3 réponses </p>
                    <div class="p_fleche" onclick="goToNextQuestion(event)">
                        <i class="fa-solid fa-circle-chevron-right" style="color: #8f8e8e;"></i>
                    </div>
                </form>
